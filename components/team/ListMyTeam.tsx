...
export default function ListMyTeam({
  listMyTeam,
  setMyTeamIndex,
}: {
  listMyTeam: DetailTeam[] | null;
  ...
  console.log(
    ...
    listMyTeam.map((team) => ({ id: team.id, members: team.members })),
  );
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:flex-1 p-3 sm:p-4">
            ...
            <div className="flex items-center justify-end sm:ml-3">
              <button
                className="py-1.5 px-3 sm:py-2 sm:px-4 border text-sm sm:text-base border-black text-black font-semibold rounded-md hover:bg-gray-100 transition duration-300"
