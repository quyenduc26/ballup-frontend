...
export default function Home() {
    ...
    return (
        <div className="min-h-[60vh] mt-10 flex items-center justify-center bg-white px-4 md:px-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 max-w-5xl w-full">
                <div>
                    <h2 className="text-xl md:text-2xl font-bold text-black">OUR SPORTS</h2>
                ...
                <div>
                    {sports.map((sport, index) => (
                        <div key={index} className="flex justify-between items-center border-b border-black py-3 md:py-4">
                            <Link href={sport.link} className="font-bold text-sm md:text-lg text-black">
                                {sport.name}
                            </Link>
