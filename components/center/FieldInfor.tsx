...
const BookingDetail = () => {
  ...
  const centerIdNumber = parseInt(Array.isArray(centerId) ? centerId[0] : centerId || "0");
      ...
      <div className="max-w-6xl mx-auto bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row gap-8 p-6">
          ...
          <div className="flex-1 space-y-4">
            <img
              src={getImageUrl(bookingInfo.imageUrls?.[0]) || "/images/default.png"}
              alt="Main field"
          ...
          <div className="flex-1 bg-gray-50 border border-gray-200 rounded-xl p-6 space-y-4 ">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold text-gray-800">{bookingInfo.name}</h1>
              <p className="text-gray-600 text-left">{bookingInfo.address}</p>
              <p className="text-gray-500 text-left">{bookingInfo.description}</p>
            </div>
