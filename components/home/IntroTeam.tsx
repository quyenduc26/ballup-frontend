...
export default function TeamSection() {
  return (
    <div className="relative w-full max-w-full mx-auto flex flex-col md:flex-row items-center justify-between py-10 mt-20 border border-gray-200 rounded-lg p-6 shadow-lg">
      ...
      {/* Nội dung chính */}
      <div className="p-4 rounded-lg text-center md:ml-20">
        <span className="text-4xl md:text-5xl font-bold">MAKE</span>
        <h2 className="text-6xl md:text-9xl font-bold text-yellow-500">TEAM</h2>
      </div>
